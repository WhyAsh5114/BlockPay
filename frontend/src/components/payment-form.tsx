...
import { CreatePayment } from "@/app/actions/create-contact";
      ...
      {showMoonpay && (
        <div className="-ml-4">
          <MoonPayBuyWidget
            ...
            onTransactionCompleted={(e) =>
              CreatePayment(address!, selectedContact, Number(amount))
            }
            walletAddress={
              contacts.find((c) => c.contactWith === selectedContact)
                ?.contactWith
            }
          />
        </div>
